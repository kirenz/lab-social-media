...
df['Beitragsinteraktionen'] = df['Beitragsinteraktionen'].astype('int')
df['Geteilte Beiträge'] = df['Geteilte Beiträge'].astype('int')
df['Beitragskommentare'] = df['Beitragskommentare'].astype('int')
